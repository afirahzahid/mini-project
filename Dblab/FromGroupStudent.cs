...
namespace Dblab
{
	public partial class FromGroupStudent : Form
	{
		public int Flags = 0;
		SqlCommand cmd1;
		SqlCommand cmd2;
		...
		private void FromGroupStudent_Load(object sender, EventArgs e)
		{
			DisplayGroup();
		}
			...
			if (UP_RowIndex == 6)
			{
				...
				if (UP_RowIndex != 0)
				{
					...
					else
					{
						con1.Close();
						this.Hide();
						FromGroupStudent f2 = new FromGroupStudent();
						f2.ShowDialog();
					}
				}
			}
